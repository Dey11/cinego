...
const Card = ({ show }: { show: CardProps }) => {
  ...
  return (
    <Link href={`/${type}/${show.id}`}>
      <div className="relative max-h-44 max-w-24 overflow-hidden hover:text-white sm:max-h-52 sm:max-w-32">
        <div className="relative h-44 w-24 overflow-hidden rounded-sm border-0 sm:h-52 sm:w-32">
          <Image
